...
function Navbar() {
  ...
  const navItems = (
    ...
    <li><a href="/contact" onClick={()=>document.getElementById('my_modal').showModal()}>Contact</a></li>
    <li><a>About</a></li>
    </>
  );
  return (
    ...
    <div className = {' max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${ sticky? "sticky-navbar shadow-md bg-base-200" : ""}'}>
  ...
  <label className="input px-3 py-2 border rounded-md flex items-center gap-2 dark:bg-slate-800 dark:text-white dark:border">
